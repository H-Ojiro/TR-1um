...
DR['CO.Z1'] = DRule(   0.0,  -1.0, 'CO','AA+PO+PR','None' )
...
DR['AP.WM'] = DRule(   3.4,  60.0, 'PMOS','AP-PO','Wmin/max' )
DR['AP.LM'] = DRule(   1.0,  30.0, 'PMOS','PO-AN','Lmin/max' )
...
DR['AN.WM'] = DRule(   3.4,  60.0, 'NMOS','AN-PO','Wmin/max' )
DR['AN.LM'] = DRule(   1.0,  30.0, 'NMOS','PO-AN','Lmin/max' )
...
DR['PO.EP'] = DRule(   1.2,  -1.0, 'PMOS','PO','ECmin' )
DR['PO.EN'] = DRule(   1.2,  -1.0, 'NMOS','PO','ECmin' )
...
DR['PO.R1'] = DRule(   0.0,  -1.0, 'AR','PO(AR)','Donut' )
DR['PO.R2'] = DRule(   0.0,  -1.0, 'PO','TieDown','' )
DR['PR.W1'] = DRule(   4.0,  20.0, 'RS','RS(L)','Wmin/max' )
DR['PR.L1'] = DRule(  20.0, 100.0, 'RS','RS(W)','Lmin/max' )
DR['PR.S1'] = DRule(   2.0,  -1.0, 'RS','RS','Smin' )
